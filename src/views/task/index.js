...
import {
    ...
    MenuItem,
    Grid,
    TextareaAutosize // Added import for TextareaAutosize
} from "@mui/material";
    ...
    return (
        <MainCard title="My Task">
            ...
            <TextField
                label="Search"
                variant="outlined"
                style={{ width: '300px',position: 'absolute', left: "35%", top: '17%', }}
                value={searchTerm}
            ...
            <Button variant="contained" style={{ backgroundColor: "#fc8019", position: 'absolute', right: "10%", top: '18%' }}>
                <FilterAltOutlined/> Result:{filteredTasks.length}
            </Button>
                    ...
                    <DialogContent>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={4}>
                                <FormControl variant="outlined" fullWidth>
                                    <InputLabel id="taskstatus-label" style={{ marginBottom: '1rem', marginTop: "1rem" }}>Task status</InputLabel>
                                    <Select
                            ...
                            <Grid item xs={4}>
                                <FormControl variant="outlined" fullWidth>
                                    <InputLabel id="assigned-to-label" style={{ marginBottom: '1rem', marginTop: "1rem" }}>Assigned to</InputLabel>
                                    <Select
                        ...
                        <Grid item xs={12}>
                            ...
                            <TextareaAutosize
                                ...
                                style={{ width: '100%', height: '20%', padding: '9px', borderRadius: '10px', border: '1px solid lightgrey', marginBottom: '1rem', marginTop: '1rem' }}
                                rowsMin={3}
                                variant="outlined"
                                fullWidth
                                ...
                                sx={{
                                    ...
                                    '& .MuiInputLabel-root': {
                                        ...
                                        '& input:placeholder + fieldset' : {
                                             borderColor: '#C7C7C7 !important',color:'black !important'
                                        }
